...
function close_cat_menu(event) {
  ...
  if (
    !document.getElementById("categories_nav").contains(event.target) &&
    !document.querySelector(".shop-button").contains(event.target) &&
    !document.querySelector(".second-shop-button").contains(event.target)
  ) {
    document.getElementById("categories_nav").classList.add("hide-nav");
  }
}
function close_ham_menu(event) {
  ...
  if (
    ...
    !document.querySelector(".ham-button").contains(event.target) &&
    !document.getElementById("categories_nav").contains(event.target)
  ) {
    document.getElementById("hamburger").classList.add("hide-nav");
  }
